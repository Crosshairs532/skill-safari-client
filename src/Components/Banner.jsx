        ...
        <div>
            <div className=' flex flex-col lg:flex-row md:flex-row pt-20 lg:justify-between container items-center mx-auto'>
                <div className=' lg:flex-[1] md:flex-1 pl-10 space-y-6 mx-auto '>
                    <h1 className=' text-4xl lg:text-7xl font-bold'> Elevate Your Online <br className=' block lg:hidden md:hidden' /> Experience with <span className=' text-orange-600'>SkillSafari</span>!</h1>
